        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Container( // 길이 제한 필요
                margin: EdgeInsets.only(left: 20.0, right: 20.0, top: 43.0), // 학번 텍스트 필드에 대한 마진 설정
                width: 320,
                height: 50,
                child: TextField(
                ...
                onChanged: (text) {
                  ...
                  decoration: InputDecoration(
                    ...
                    contentPadding: EdgeInsets.only(left: 17, right: 17), // 텍스트를 수직으로 가운데 정렬
                    filled: true,
              ...
              Container(
                margin: EdgeInsets.only(left: 20.0, right: 20.0, top: 6.0), // 비밀번호 텍스트 필드에 대한 마진 설정
                width: 320,
                height: 50,
                child: TextField(
                  maxLength: maxPasswordLength, // 비밀번호 텍스트 필드의 최대 길이 설정
                  onChanged: (text) {
              ...
              Container(
                ...
                child: TextButton(
                  ...
                  style: ButtonStyle(
                    minimumSize: MaterialStateProperty.all(Size(100, 29)), // 버튼 크기
                  ),
                  child: Text(
                    "회원가입",
                    style: TextStyle(
