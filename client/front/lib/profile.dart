...
class _ProfileScreenState extends State<ProfileScreen> {
  TextEditingController nameController = TextEditingController();   // 닉네임 입력란의 상태 관리 -> 중복확인
  ...
  @override
  void initState() { // 위젯의 초기 상태 설정 = 이메일 및 인증 코드 입력란의 상태 변화 감지
    super.initState();
  ...
  @override
  void dispose() { // 위젯이 제거될 때 호출됨
    nameController.dispose();
    passwordCheckController.dispose();
    super.dispose();
  }

  void updateNameButtonState() { // 중복확인 입력란의 텍스트 변경 감지하여 이메일 전성 버튼의 활성화 상태 업데이트
    setState(() {
      isNameButtonEnabled = nameController.text.isNotEmpty;
    });
  }

  void updatePasswordCheckButtonState() { // 비밀번호 확인 입력란의 텍스트 변경 감지하여 확인 버튼의 활성화 상태 업데이트
    setState(() {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.only(top: 9.74),  // 전체 마진
                        width: 321, // 245 + 9.98 + 66.02
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: Container(
                                margin: EdgeInsets.only(right: 9.98), // 닉네임 텍스트 필드와 중복확인 버튼 사이의 간격
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    labelStyle: TextStyle(
                                        ...
                                        fontFamily: 'Pretendard',
                                        fontWeight: FontWeight.w400),
                                    contentPadding: EdgeInsets.only(left: 10, right: 10), // 텍스트를 수직으로 가운데 정렬
                            ...
                            child: ElevatedButton(
                                ...
                                style: ButtonStyle(
                                  padding: MaterialStateProperty.all<EdgeInsetsGeometry>(EdgeInsets.all(10.01)),
                                backgroundColor: MaterialStateProperty.all<Color>(Color(0xFF7C3D1A)),
                                // 버튼의 크기 설정
                                minimumSize: MaterialStateProperty.all<Size>(Size(66.02, 38)),
                                // 버튼의 모양 변경
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          obscureText: !isPasswordButtonVisible, // 비밀번호 가리기/보이기 설정
                          ...
                          decoration: InputDecoration(
                            ...
                            labelStyle: TextStyle(
                                ...
                                fontFamily: 'Pretendard',
                                fontWeight: FontWeight.w400),
                            contentPadding: EdgeInsets.only(left: 11.58), // 텍스트를 수직으로 가운데 정렬
                            border: InputBorder.none, // 밑줄 없애기
/*                                border: InputBorder.none, // 테두리 없애기*/
                            ...
                            suffixIcon: IconButton(
                              onPressed: () {
                                setState(() {
                                  isPasswordCheckButtonVisible = !isPasswordCheckButtonVisible; // 상태를 반전시켜서 눈모양 버튼을 클릭할 때마다 비밀번호 보이기/가리기 토글
                                });
                              },
                              icon: isPasswordCheckButtonVisible ? Image.asset('assets/images/open eye.png') : Image.asset('assets/images/close eye.png'), // 이미지 아이콘 설정
                             ),
                            ),
                          keyboardType: TextInputType.text,
                        ),
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          obscureText: !isPasswordCheckButtonVisible, // 비밀번호 확인 가리기/보이기 설정
                      ...
                      child: ElevatedButton(
                        ...
                        style: ButtonStyle(
                          // 버튼의 배경색 변경하기
                          backgroundColor: isPasswordCheckButtonEnabled ? MaterialStateProperty.all<Color>(Color(0xFF7C3D1A)) : MaterialStateProperty.all<Color>(Color(0xFFBD9E8C)),
