...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void updateEmailButtonState() { // 이메일 입력란의 텍스트 변경 감지하여 이메일 전성 버튼의 활성화 상태 업데이트
    setState(() {
      isEmailButtonEnabled = emailController.text.isNotEmpty;
    });
  }

  void updateVerifyButtonState() { // 인증 코드 입력란의 텍스트 변경 감지하여 이메일 전성 버튼의 활성화 상태 업데이트
    setState(() {
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          Container(
                            margin: EdgeInsets.only(left: 22,top: 33.0), // 비밀번호 텍스트 필드에 대한 마진 설정
                          child: Align(
                          ...
                          Container(
                            margin: EdgeInsets.only(top: 11.0), // 비밀번호 텍스트 필드에 대한 마진 설정
                            width: 320,
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle: TextStyle(
                                    ...
                                    fontFamily: 'Pretendard',
                                    fontWeight: FontWeight.w400),
                                contentPadding: EdgeInsets.only(left: 14, right: 14), // 텍스트를 수직으로 가운데 정렬
                          ...
                          Container(
                            margin: EdgeInsets.only(top: 0), // 비밀번호 텍스트 필드에 대한 마진 설정
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle: TextStyle(
                                    ...
                                    fontFamily: 'Pretendard',
                                    fontWeight: FontWeight.w400),
                                contentPadding: EdgeInsets.only(left: 11, right: 11), // 텍스트를 수직으로 가운데 정렬
                                border: InputBorder.none, // 밑줄 없애기
